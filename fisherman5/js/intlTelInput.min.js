					...
					d(c, [
						...
						},
						{
							...
							value: function () {
								...
								(b && !c ?
									this._v(a)
								:	"auto" !== e &&
									(e ? this._z(e.toLowerCase())
									: b && c ? this._z("us")
									: ((this.j = this.preferredCountries.length ? this.preferredCountries[0].iso2 : this.p[0].iso2), a || this._z(this.j)),
						...
						},
						{
							...
							value: function () {
								...
								((this._a3 = function (b) {
									(b.preventDefault(),
										"ArrowUp" === b.key || "Up" === b.key || "ArrowDown" === b.key || "Down" === b.key ? a._q(b.key)
										: "Enter" === b.key ? a._r()
										: "Escape" === b.key ? a._2()
