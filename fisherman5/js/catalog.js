$(document).ready(function () {
	...
	const directoryFilterToggle = document.querySelectorAll(".directory-filter__toggle");
	...
	// Toggle block on filter
	directoryFilterToggle.forEach((el) => {
		el.addEventListener("click", () => {
			...
			// Сброс состояния для остальных кнопок в группе
			directoryFilterToggle.forEach((other) => {
				if (other !== el) other.dataset.waschecked = "false";
			});
		});
	});
