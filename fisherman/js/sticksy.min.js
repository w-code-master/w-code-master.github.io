window.Sticksy = (function () {
	...
	((e.instances = []),
		...
		(e.prototype.g = function () {
			this.t.listen && !this.v && (this.p.observe(this.t.containerEl, { attributes: !0, characterData: !0, childList: !0, subtree: !0 }), (this.v = !0));
		}),
		...
		(e.prototype.j = function () {
			...
			this.l = { top: i.topWithMargin - this.t.topSpacing, bottom: t.bottom - t.paddingBottom - this.t.topSpacing - this.u };
		}),
		...
		(e.initializeAll = function (t, i, n) {
			...
			: void 0 !== t.length && 0 < t.length && t[0] instanceof Element ? (s = "function" == typeof t.get ? t.get() : t)
	...
	var r = {
		...
		findElement: function (t, i) {
			return (
				(i = i || document),
				"string" == typeof t ? i.querySelector(t)
