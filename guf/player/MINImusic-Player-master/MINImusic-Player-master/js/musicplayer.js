            ...
            init: function() {
                ...
                for( var elemItem in this.settings.elements )
                {
                    ...
                    if (this.settings.elements[elemItem] == "volume" ) {
                        ...
                        volumeElem   = "<div class='volume'><div class='volume-inner'><div class='volume-btn'><i class='i-player-sound'></i><i class='i-player-sound-none'></i></div><div class='volume-adjust'><div><div></div></div></div></div></div>" ;
                    ...
                    //PREPARE CONTROLS inner elements to display [play, stop, forward or backward] in the given order
                        ...
                        $.inArray("backward", this.settings.controlElements) != '-1'  ? backwardElem   = "<div class='rew'><i class='i-player-prev'></i></div>"      : backwardElem  = " " ;
                        $.inArray("forward", this.settings.controlElements)  != '-1'  ? forwardElem    = "<div class='fwd'><i class='i-player-next'></i></div>"        : forwardElem   = " " ;
                        $.inArray("stop", this.settings.controlElements) != '-1'      ? stopElem       = "<div class='stop'><i class='i-player-stop'></i></div>"       : stopElem      = " " ;
                        $.inArray("play", this.settings.controlElements) != '-1'      ? playElem       = "<div class='play'><i class='i-player-play'></i></div><div class='pause'><i class='i-player-pause'></i></div>" : playElem  = " " ;
                        ...
                        controlElem   = "<div class='wrap-controls'><div class='controls'>" + controlInnerElem + "</div></div>";
                ...
                playerElem = $("<div class='player'><div class='wrap-player'>" + fullPlayerElem + "<div class='playlist-btn'><i class='i-player-playlist'></i></div></div></div>");
